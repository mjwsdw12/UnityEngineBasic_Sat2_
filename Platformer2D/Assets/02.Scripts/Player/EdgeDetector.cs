...
{
    public bool IsDetected => (BottomOn == true) && (TopOn == false);
    ...
    public float TopY => _rb.position.y + _col.size.y * _col.gameObject.transform.lossyScale.y + 0.05f;
    public float BottomY => _rb.position.y + _col.size.y * _col.gameObject.transform.lossyScale.y;

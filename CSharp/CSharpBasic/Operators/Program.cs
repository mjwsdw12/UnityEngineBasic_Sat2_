...
namespace Operators
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            // 증가 연산
            ++c; // 전위연산 : 해당 라인의 연산을 먼저 수행한 뒤 명령 실행 (자주 사용 X)
            ...
            // 조건부 or
            // 첫번째 피연산자가 true면 B비교 하지 않고 true 반환
            Console.WriteLine(A || B);

            // 조건부 and
            // 첫번째 피연산자가 false면 B비교 하지 않고 false 반환
            Console.WriteLine(A && B);
            ...
            // 정수형 연산할때 보통 씀
            //==========================================================
            int howManyBitYouWamtToShift = 1;
            ...
            Console.WriteLine(a ^ b);
            Console.WriteLine(~a);
            Console.WriteLine(a << howManyBitYouWamtToShift);
            Console.WriteLine(a >> howManyBitYouWamtToShift);
        }
    }
}
